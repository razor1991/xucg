...
ucg_plan_meta_op_t* ucg_planc_ucx_barrier_na_kntree_op_new(ucg_planc_ucx_group_t* ucx_group,
                                                           ucg_vgroup_t *vgroup,
                                                     ...
                                                     ucg_plan_op_t **op)
{
    ...
    ucg_plan_meta_op_t *meta_op = ucg_planc_ucx_barrier_na_kntree_op_new(ucx_group, vgroup, args, config);
    if (meta_op == NULL) {
