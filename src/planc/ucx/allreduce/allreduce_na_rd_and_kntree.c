...
static ucg_status_t ucg_planc_ucx_allreduce_na_rd_and_kntree_check(ucg_vgroup_t *vgroup,
                                                              ...
                                                              ucg_plan_op_t **op)
{
    ...
    ucg_status_t status;
    status = ucg_planc_ucx_allreduce_na_rd_and_kntree_check(vgroup, args);
    if (status != UCG_OK) {
        return UCG_ERR_UNSUPPORTED;
    }
